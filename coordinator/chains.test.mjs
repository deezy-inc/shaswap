...
ck(q.reorgModel === "fixed" && q.fixedConfs === 1 && q.fixedMaxConfs === 12 && q.fixedScaleBtc === 0.01, "bip110 fixed-confs model: 1 conf base, value-scaled to 12 max (Blake2b hashrate can't be subsidy-priced)");
